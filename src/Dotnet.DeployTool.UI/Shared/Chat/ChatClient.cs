...
namespace Dotnet.DeployTool.UI.Shared.Chat
{
    /// <summary>
    ...
    public class ChatClient : IAsyncDisposable
    {
        ...
        public async Task StartAsync()
        {
            if (!_started)
            {
                ...
                _hubConnection.On<string, string>(ChatMessageTypes.RECEIVE, (user, message) =>
                {
                ...
                await _hubConnection.SendAsync(ChatMessageTypes.REGISTER, _username);
            }
        }
        ...
        public async Task SendAsync(string message)
        {
            ...
            // send the message
            await _hubConnection.SendAsync(ChatMessageTypes.SEND, _username, message);
        }
